...
function updateAnimation(particle, data, changeDirection, destroyType, delta) {
  const minLoops2 = 0, minDelay = 0, identity4 = 1, minVelocity7 = 0, minDecay = 1;
...
function updateColorValue(data, range, decrease, delta) {
  const minLoops2 = 0, minDelay = 0, identity4 = 1, minVelocity7 = 0, minOffset = 0, velocityFactor = 3.6;
  ...
  const offset = data.offset ? randomInRange(data.offset) : minOffset, velocity = (data.velocity ?? minVelocity7) * delta.factor + offset * velocityFactor, decay = data.decay ?? identity4, max = getRangeMax(range), min = getRangeMin(range);
...
var EmittersSquareShape = class extends EmitterShapeBase {
  ...
  randomPosition() {
    ...
    if (fill) {
      ...
      const halfW = size.width * half, halfH = size.height * half, side = Math.floor(getRandom() * sides2), v = (getRandom() - half) * double;
      switch (side) {
        case Sides.TopLeft:
          return {
            position: {
...
//# sourceMappingURL=chunk-NG6N3RQ4.js.map
